class EmployesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employe.save
        format.html { redirect_to @employe, notice: "Empleado fue creado con éxito" }
  ...
  def update
    respond_to do |format|
      if @employe.update(employe_params)
        format.html { redirect_to @employe, notice: "Empleado fue actualizado con éxito" }
  ...
  def destroy
    @employe.destroy
    respond_to do |format|
      format.html { redirect_to employes_url, notice: "Empleado fue eliminado con  éxito" }
  ...
  private
    ...
    def employe_params
      params.require(:employe).permit(:name, :last_name, :age, :telephone, :salary, :cargo)
    end
end
