...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { age: @empleado.age, cargo: @empleado.cargo, last_name: @empleado.last_name, name: @empleado.name, salary: @empleado.salary, telephone: @empleado.telephone } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { age: @empleado.age, cargo: @empleado.cargo, last_name: @empleado.last_name, name: @empleado.name, salary: @empleado.salary, telephone: @empleado.telephone } }
