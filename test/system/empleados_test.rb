...
class EmpleadosTest < ApplicationSystemTestCase
  ...
  test "creating a Empleado" do
    ...
    fill_in "Age", with: @empleado.age
    fill_in "Cargo", with: @empleado.cargo
    fill_in "Last name", with: @empleado.last_name
    fill_in "Name", with: @empleado.name
    fill_in "Salary", with: @empleado.salary
    fill_in "Telephone", with: @empleado.telephone
